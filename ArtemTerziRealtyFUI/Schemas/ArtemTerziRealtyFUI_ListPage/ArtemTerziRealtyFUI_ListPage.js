define("ArtemTerziRealtyFUI_ListPage", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
					...
					"columns": [
						{
							...
							"code": "PDS_ArtemTerziName",
							"caption": "#ResourceString(PDS_ArtemTerziName)#",
							"dataValueType": 1
						},
						{
			...
			},
			{
				...
				"values": {
					...
					"rootSchemaName": "ArtemTerziRealtyFUI",
					"layoutConfig": {
						"width": 328.125
					},
